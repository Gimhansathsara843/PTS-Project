          ...
          <div class="offers_area padding_top">
            <div class="container">
              <div class="row">
                ...
                <form:form id ="myForm"  method="post"   enctype="multipart/form-data" action="ViewUploadingMeterReadingFileS"
 ...
 --%>
                        ...
                        <div class="room-type" id="payUnit">
                          ...
                          <div class="input-group">
                            <form:select id="metercycle" class="form-control" path="metercycle" onclick="submitForm()">
                         ...
                         <div class="room-type" id="payUnit">
                          <!-- <label for="dutyRooms">View File</label>
                           --><div class="input-group">
                            <!-- <input  type="file" name="file" class="form-control">
							 -->									                          </div>
                           <div class="col-xl-12 mb-3 mt-2 center ">
                            <input type="submit" class="boxed-btn3" id="booking_btn" onclick="submitForm()" value="View">
                            ...
                            <div class="fresh-table full-color">
                                ...
                                <table class="table table-striped" id="bookingTable">
                                    ...
                                    <tbody id="bookingTableBody">
                                        <c:forEach var="filelist" items="${model.fileList}" varStatus="status">
                                            <tr>
                                                <td>${filelist.id.billCycleNo}</td>
                                                <td>${filelist.id.cebSerialNo}</td>
                                                <td>${filelist.serialNo}</td>
                                                <td>${filelist.fileName}</td>
                                                <td>${filelist.fileType}</td>
                                                <td>
                                                    <button type="button" class="review-btn"
                                                         onClick='viewFile("${filelist.fileName}")'>View</button></td>
        ...
        function viewFile(path){
            // alert(bookingid);
       		 var url="viewFile?pathName="+path;
         	    var width = 1100;
         	    var height = 700;
