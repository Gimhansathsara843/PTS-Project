...
import com.it.ceb.admin.domain.Sauserm;
...
public class SecurityDaoImpl implements SecurityDao {
	...
	public List<String> getUserList(String deptId, String userLevel) {
		String qryStr = "SELECT TRIM(userId) FROM Sauserm s WHERE TRIM(s.rptUser)=:rptUser AND s.userLevel =:userLevel and s.status=2";
		Query query = em.createQuery(qryStr);
	...
	@Override
	public List<Sauserm> getAllUserByRptUserEEES(String rpt_user,
			String user_leve) {
		// TODO Auto-generated method stub
		return null;
	}
