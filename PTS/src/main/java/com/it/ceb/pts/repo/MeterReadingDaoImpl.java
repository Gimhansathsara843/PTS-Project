...
//    }
    ...
    public List<MeterReadingResultModel> getMeterReadingsFull(Long billCycle, String division, String province) throws Exception {
        try {
            TypedQuery<MeterReadingResultModel> query = entityManager.createQuery(
                    "SELECT new com.it.ceb.util.common.models.MeterReadingResultModel( " +
    ...
    public List<MeterReadingErrorResultModel> getMeterReadingErrors(Long billCycle, String division, String province) throws Exception{
        ...
        try{
            TypedQuery<MeterReadingErrorResultModel> query = entityManager.createQuery("SELECT " +
                    "new com.it.ceb.util.common.models.MeterReadingErrorResultModel" +
                    "(mr.serialNo, mr.cebSerialNo, mr.errorLogId, mr.status, mr.reason, mr.attempts) " +
                    "FROM MeterReadingErrLog mr " +
                    "WHERE mr.meterReadingLog.id = :logID", MeterReadingErrorResultModel.class);
    ...
    public List<MeterReadingRecordModel> getMeterReadings(Long billCycleNo, String provinceCode, String licenseCode) throws Exception {
        try {
            TypedQuery<MeterReadingRecordModel> query = entityManager.createQuery(
                    "SELECT new com.it.ceb.util.common.models.MeterReadingRecordModel(" +
                            "mr.readingId, mr.measure.measureName,mr.currentReading, mr.previousReading, mr.energy,mr.point.id) " +
                            "FROM MeterReading mr " +
    ...
    public List<MeterPointModel> getMeterPoints(String provinceCode, String licenseCode) throws Exception {
        try {
            TypedQuery<MeterPointModel>query = entityManager.createQuery("SELECT " +
                            "new com.it.ceb.util.common.models.MeterPointModel(mp.id,mp.serialNo,mp.meter.cebSerialNo,mp.area.areaName,mp.primarySubstation.pssName) " +
                            "FROM MeterPoint mp " +
    ...
    public List<String> getErrorMeterList(Long billCycle, String division, String province) throws Exception{
        ...
        try{
            TypedQuery<String> query = entityManager.createQuery("SELECT mrel.cebSerialNo FROM MeterReadingErrLog mrel" +
                    " WHERE mrel.meterReadingLog.readingLogId = : logID " +
                    "AND mrel.status = : status", String.class);
            query.setParameter("logID", logID);
