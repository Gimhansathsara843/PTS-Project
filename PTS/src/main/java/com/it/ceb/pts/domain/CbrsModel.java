...
public class CbrsModel {
	...
	List<DistributionLicense> divisionList = new ArrayList<>();

	public List<DistributionLicense> getdivisionList() {
		return divisionList;
	}

	public void setdivisionList(List<DistributionLicense> divisionList) {
